...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <PropertyGroup>
    ...
    <ProjectGuid>15e2e35e-f56e-47da-9536-ded64d31f1ac</ProjectGuid>
    <OutputName>pololu-usb-avr-programmer-v2-$(ProductVersion)-win</OutputName>
    <DefineConstants>
      ProductVersion=$(ProductVersion);
      DocumentationUrl=https://www.pololu.com/docs/0J67;
    </DefineConstants>
...
<Wix xmlns="http://schemas.microsoft.com/wix/2006/wi"
  ...
  <Product Name="Pololu USB AVR Programmer v2"
          ...
          <Directory Id="INSTALLDIR" Name="USB AVR Programmer v2">
            ...
            <Directory Id="DriversDir" Name="drivers" FileSource="drivers/">
              <Component Id="MainInf">
                <File Id="MainInf" Name="pavr2.inf" />
              </Component>
              <Component Id="SerialInf">
                <File Id="SerialInf" Name="pavr2-serial.inf" />
              </Component>
              <Component Id="BootloaderInf">
                <File Id="BootloaderInf" Name="pavr2-bootloader.inf" />
              </Component>
    ...
    <InstallExecuteSequence>
      ...
      <Custom Action="InstallInf3" After="InstallInf3.SetProperty">(NOT Installed) OR REINSTALLMODE</Custom>
...
<WixLocalization Culture="en-us" xmlns="http://schemas.microsoft.com/wix/2006/localization">
  <String Id="WelcomeDlgDescription">The Setup Wizard will install the software and drivers for the Pololu USB AVR Programmer v2 and v2.1 on your computer.  Please note that "v2" refers to the versions of the hardware products.  The version number of this software is [ProductVersion].  Click Next to continue or Cancel to exit the Setup Wizard.</String>
  ...
  <String Id="ModifyPathDlgNote">This is not required but will make it easier to run pavr2cmd from the Command Prompt.</String>
</WixLocalization>
EOF
end
...
"$SIGNTOOL" sign $SIGNFLAGS -d "Pololu USB AVR Programmer v2 Setup" *.msi
EOF
end
