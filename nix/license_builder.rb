...
<body>
<p>
  The Pololu USB AVR Programmer v2 software distribution is licensed under the
  GPLv3, subject to the restrictions described below.
<p>
  Source code and instructions for building this software can be found in the
  <a href="https://github.com/pololu/pololu-usb-avr-programmer-v2">pololu-usb-avr-programmer-v2</a> repository.
<p>
  This release was built from
  <a href="https://github.com/pololu/pololu-usb-avr-programmer-v2/tree/#{ENV.fetch('commit')}">
  pololu-usb-avr-programmer-v2 commit #{ENV.fetch('commit')[0, 7]}</a>,
